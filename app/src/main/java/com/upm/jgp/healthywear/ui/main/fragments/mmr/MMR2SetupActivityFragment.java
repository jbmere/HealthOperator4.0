 ...
 * @since 2022
 */
public class MMR2SetupActivityFragment extends Fragment implements ServiceConnection {
    public interface FragmentSettings2 {
        BluetoothDevice getBtDevice_mmr2();
    }

    private static MetaWearBoard metawear = null;
    private FragmentSettings2 settings;
    private String mmrMAC = null;
    private final int TYPEMMR = 3;
    private static Activity owner2;

    public MMR2SetupActivityFragment() {
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        owner2 = getActivity();
        if (!(owner2 instanceof FragmentSettings2)) {
            throw new ClassCastException("Owning activity must implement the FragmentSettings interface");
        }

        settings = (FragmentSettings2) owner2;
        owner2.getApplicationContext().bindService(new Intent(owner2, BtleService.class), this, Context.BIND_AUTO_CREATE);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_tab_mmr2, container, false);
    }
    ...
    private String folderPath2 = Environment.getExternalStorageDirectory().getPath() + File.separator + "tmp2" + File.separator + "cache" + File.separator;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        fab = view.findViewById(R.id.fabMMR2fav);
        ...
        tv_mac = view.findViewById(R.id.mmr2_value_mac);     //device MAC
        tv_temp = view.findViewById(R.id.mmr2_value_temp);    //Temp data
        tv_illm = view.findViewById(R.id.mmr2_value_illum);    //Illum data
        tv_alt = view.findViewById(R.id.mmr2_value_alt);    //Altitude data
        tv_arm = view.findViewById(R.id.mmr2_value_arm);    //arm angle
        tv_acc = view.findViewById(R.id.mmr2_value_acc);    //acceleration
        tv_gps = view.findViewById(R.id.mmr2_value_gps);    //location gps


        view.findViewById(R.id.mmr2_acc_start).setOnClickListener(new View.OnClickListener() {
            @Override
                        ...
                        source.stream(new Subscriber() {
                            ...
                            public void apply(Data data, Object... env) {
                                ...
                                if (n % 750 == 0) {
                                    ...
                                    String toplines = "{'us':'USER','pass':'PASSWORD','db':'DBNAME','collection':'mmr2_acc'}\n" +
...
/*
        ...
        view.findViewById(R.id.mmr2_acc_stop).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    public void onServiceConnected(ComponentName name, IBinder service) {
        ...
        if (settings.getBtDevice_mmr2() != null) {
            metawear = ((BtleService.LocalBinder) service).getMetaWearBoard(settings.getBtDevice_mmr2());
            ...
            metawear = ((BtleService.LocalBinder) service).getMetaWearBoard(MainActivity.getMmr2_device_global());
            if (metawear != null) {
                mmrMAC = metawear.getMacAddress();
            }
        }
        ...
        File cachefolder = new File(Environment.getExternalStorageDirectory().getPath() + File.separator + "tmp2" + File.separator + "cache");
        if (!cachefolder.exists())
            cachefolder.mkdirs();
        File backfolder = new File(Environment.getExternalStorageDirectory().getPath() + File.separator + "tmp2" + File.separator + "backup");
...
*/
  ...
  /*  public boolean isExternalStorageWritable() {
    ...
    public void initializeTimerTask() {
        timerTask = new TimerTask() {
            public void run() {
                ...
                String folderpath2 = Environment.getExternalStorageDirectory().getPath() + File.separator + "tmp2" + File.separator + "cache";
                String bkpfolder = Environment.getExternalStorageDirectory().getPath() + File.separator + "tmp2" + File.separator + "backup";
                ...
                try {
                    ...
                    if (filegz != null && filegz.length > 0) {
                        ...
                        try {
                            File file[] = finder(folderpath2);  //get all the .txt file
                            //if (file.length > 0) {
                            if (file != null && file.length > 0) {
                                for (int i = 0; i < file.length; i++) //Send all the files to the server one by one.
                                {
                                    ...
                                    String srcpath = folderpath2 + File.separator + file[i].getName();
    ...
    public String countgz(String filepath) {
        ...
        String folderpath2 = Environment.getExternalStorageDirectory().getPath() + File.separator + "tmp2" + File.separator + "cache" + File.separator;
        String firstname = fullname.substring(0, fullname.indexOf("."));
        //System.out.println("fullname:"+fullname+"folderpath:"+folderpath+"firstname:"+firstname);
        File gzf = new File(folderpath2);
        int count = 0;
